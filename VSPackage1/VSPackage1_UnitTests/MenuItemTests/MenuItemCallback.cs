...
namespace VSPackage1_UnitTests.MenuItemTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void InitializeMenuCommand()
        {
            ...
            CommandID menuCommandID = new CommandID(EidPassportInc.VSPackage1.GuidList.guidVSPackage1CmdSet, (int)EidPassportInc.VSPackage1.PkgCmdIDList.cmdidSureIDCommandTest);
